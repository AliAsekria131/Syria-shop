    ...
    <AppLayout>
      <div className="max-w-3xl mx-auto p-6">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold mb-3">عن المنصة</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">خدماتنا</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">رؤيتنا</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">تواصل معنا</h2>
